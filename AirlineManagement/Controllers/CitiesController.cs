...
namespace AirlineManagement.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(AirlineContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IsActive,DateCreated,CreatedBy,DateModified,ModifiedBy")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IsActive,DateCreated,CreatedBy,DateModified,ModifiedBy")] City city)
        {
            if (id != city.Id)
            {
                return NotFound();
