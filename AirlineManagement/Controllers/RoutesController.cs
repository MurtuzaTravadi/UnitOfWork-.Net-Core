...
namespace AirlineManagement.Controllers
{
    public class RoutesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DateCreated,CreatedBy,DateModified,ModifiedBy")] Route route)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DateCreated,CreatedBy,DateModified,ModifiedBy")] Route route)
        {
            if (id != route.Id)
            {
                return NotFound();
